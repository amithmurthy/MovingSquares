    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        xPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	int number = Integer.parseInt(xPosText.getText());
            	panel.setCurrentXPos(number);
                //complete this
            }
        });
        ...
        yPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	int numb_1 = Integer.parseInt(yPosText.getText());
            	panel.setCurrentYPos(numb_1);
                //complete this
            }
        });
        ...
        heightText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	int h_1 = Integer.parseInt(heightText.getText());
            	panel.setCurrentHeight(h_1);
                //complete this
            }
        });
        ...
        widthText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	int w_1 = Integer.parseInt(widthText.getText());
            	panel.setCurrentWidth(w_1);
                //complete this
            }
        });
